...
public class SnakeGame extends JPanel implements ActionListener, MouseMotionListener {
    ...
    private Color snakeColor = new Color(rand.nextFloat(), rand.nextFloat(), rand.nextFloat()); // tạo màu cố định cho
                                                                                                // rắn khi bắt đầu game
    ...
    public SnakeGame(String playerName) {
        ...
        try {
            backgroundImage = ImageIO.read(new File(
                    "C://Users//ADMIN//OneDrive//Desktop//snakegameonline//Client//GameVisual//background.jpg")); // Đường
                                                                                                                  // dẫn
                                                                                                                  // ảnh
                                                                                                                  // nền
        } catch (IOException e) {
    ...
    // // Constructor mới, thay glowColor bằng glowImage (hình ảnh với hiệu ứng
    // blur)
    ...
    // g.drawImage(glowImage, position.x - 5, position.y - 5, glowSize, glowSize,
    // null);
    // }
    // }
...
=======
            ...
            // Vẽ rắn
            drawSnake(g);
>>>>>>> 01ac4e59405c10652fd8128307bc8c4f9962b6be
    ...
    public void drawSnake(Graphics g) {
        ...
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); // Kích hoạt chống
                                                                                                  // răng cưa
        ...
        g2d.fillOval(head.x + eyeOffsetX1 + 2 - viewportX, head.y + eyeOffsetY1 + 2 - viewportY, 5, 5); // Con ngươi
                                                                                                        // trái
        g2d.fillOval(head.x + eyeOffsetX2 + 2 - viewportX, head.y + eyeOffsetY2 + 2 - viewportY, 5, 5); // Con ngươi
                                                                                                        // phải
...
<<<<<<< HEAD
        head.translate((int) (DOT_SIZE * Math.cos(angle)) / 2, (int) (DOT_SIZE * Math.sin(angle)) / 2);
=======
